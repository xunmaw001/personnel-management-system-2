...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<select name="zhiwei" id="zhiweiSelect" class="form-control form-control-sm" aria-controls="tableId">
									</select>
	...
	<script>
		...
		function search(){
			...
			var zhiweiIndex = document.getElementById("zhiweiSelect").selectedIndex;
			var zhiweiOptions = document.getElementById("zhiweiSelect").options;
			var zhiweiSelectedOption = zhiweiOptions[zhiweiIndex]
			if(zhiweiSelectedOption.text != null && zhiweiSelectedOption.text != ''){
				searchForm.zhiwei = "%" + zhiweiSelectedOption.text + "%";
			}
			getDataList();
		}		
		// 获取数据列表
		...
		function zhiweiSelect(){
			...
			http("option/zhiwei/zhiwei","GET",{},(res)=>{
				if(res.code == 0){
					...
					zhiweiSelect.appendChild(nullOption);
