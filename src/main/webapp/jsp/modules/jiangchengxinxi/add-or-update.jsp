...
<body>
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>奖惩名称</label>
										<input id="jiangchengmingcheng" name="jiangchengmingcheng" class="form-control" placeholder="奖惩名称">
									</div>
									<div class="form-group col-md-6">
										<label>奖惩类型</label>
									...
									<div class="form-group col-md-6">
										<label>奖惩内容</label>
										<textarea name="jiangchengneirong" class="form-control" id="jiangchengneirong" rows="3"></textarea>
									</div>
									<div class="form-group col-md-6">
										<label>员工工号</label>
	...
	<script>
		...
		function dataBind(){
			...
			$("#jiangchengmingcheng").val(ruleForm.jiangchengmingcheng);	
			...
			$("#jiangchengneirong").val(ruleForm.jiangchengneirong);
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.jiangchengmingcheng != null && res.data.jiangchengmingcheng != ''){

					$("#jiangchengmingcheng").val(res.data.jiangchengmingcheng);
					}
					...
					if(res.data != null && res.data != '' && res.data.jiangchengneirong != null && res.data.jiangchengneirong != ''){

					$("#jiangchengneirong").val(res.data.jiangchengneirong);
					}
