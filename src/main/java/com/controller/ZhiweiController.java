...
public class ZhiweiController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,ZhiweiEntity zhiwei, HttpServletRequest request){
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,ZhiweiEntity zhiwei, HttpServletRequest request){
        EntityWrapper<ZhiweiEntity> ew = new EntityWrapper<ZhiweiEntity>();
    	PageUtils page = zhiweiService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, zhiwei), params), params));
		request.setAttribute("data", page);
        return R.ok().put("data", page);
